...
var data = [
  {
    ...
    thoughts:
      "The debate over whether the Net is good or bad for us fills the airwaves and the blogosphere. But for all the heat of claim and counter-claim, the argument is essentially beside the point: it’s here; it’s everywhere.   ",
  ...
  },
  {
    ...
    thoughts:
      "What Tolle is talking about are the practices of mindfulness and disidentifying with your thoughts (both of which are now being massively taken up in one form or another in Western cognitive-behavioral therapy). The book is another way of talking about what Buddhists and yogis have been saying for a very long time.  ",
    comments: ["59e034dfb6d54d54eb3e0bda", "59e034eab6d54d54eb3e0bdb"],
    postedBy: {
      id: "59e033bab6d54d54eb3e0bd4",
      username: "JohnDoe",
...
var userData = [
  ...
  },
  {
    ...
    username: "tt",
    local: {
      password: "$2a$08$uUUan3w7H1Wp6e7WG8VANuVxdZdXO5EGwxz0T/.5trxCLnP486qu2'",
      email: "tt"
    },
    followers: [],
    __v: 0
