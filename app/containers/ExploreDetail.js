...
export default class ExploreDetail extends React.Component<Props> {
  ...
  render() {
    const imageUrl = this.props.location.state.volumeInfo.imageLinks
      ? this.props.location.state.volumeInfo.imageLinks.smallThumbnail : '/images/no_results.svg';
    const title = this.props.location.state ? this.props.location.state.volumeInfo.title : '';
    const publishedDate = this.props.location.state ? this.props.location.state.volumeInfo.publishedDate : '';
          ...
          <div className="ui item">
            ...
            <div className={styles.detailContent}>
              <div className="content">
                ...
                <button className="ui mini positive basic button">Add to reading list</button>
                <div className="meta">
                  <span className={styles.detailMeta}>Authors: {authors}</span>
                  <span className={styles.detailMeta}>Published: {publishedDate}</span>
                </div>
            </div>
          </div>
          </div>
